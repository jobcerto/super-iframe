  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return axios__WEBPACK_IMPORTED_MODULE_4__["default"].get("https://igames.job/api/auth/?api_token=".concat(token));
        case 2:
...
var initializeIframe = function initializeIframe() {
  ...
  var gamesCollection = collect_js__WEBPACK_IMPORTED_MODULE_2___default()(games !== null && games !== void 0 ? games : store.games);
